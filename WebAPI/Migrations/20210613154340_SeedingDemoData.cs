...
{
    public partial class SeedingDemoData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            where Username='Demo')
            insert into Users
                (Username,Password, PasswordKey,LastUpdateOn,LastUpdateBy)
            select 'Demo',
            ...
            insert into PropertyTypes
                (Name,LastUpdateOn,LastUpdateBy)
            ...
            from Cities)
            Insert into Cities
                (Name,LastUpdateBy,LastUpdateOn,Country)
            ...
            insert into Properties
                ...
                Address2,CityId,FloorNo,TotalFloors,ReadyToMove,MainEntrance,Security,Gated,Maintenance,EstPossessionOn,Age,Description,PostedOn,PostedBy,LastUpdateOn,LastUpdateBy)
            select
                1, --Sell Rent
